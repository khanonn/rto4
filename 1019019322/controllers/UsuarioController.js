...
module.exports = {
    add: async(req, res, next) => {
        try {
            ...
            res.status(200).json(reg);//1era correccion
        } catch (e) {
            res.status(500).send({
    ...
    list: async(req, res, next) => {
        try {
            ...
            res.status(200).json(reg);//cambio
        } catch (e) {
            res.status(500).send({//cambio
                message: 'Ocurrió un error'
            });
            next(e);
        }
        ...
        try {
            ...
            if (user) {
                ...
                if (match) {
                    ...
                    res.status(200).json({ user, tokenReturn });////200
                } else {
